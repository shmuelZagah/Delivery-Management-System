...
[Serializable]
/// <summary>
/// Thrown when the simulator is running.
/// </summary> 
public class BlSimulationRunningException : Exception
{
    public BlSimulationRunningException(string? message)
        : base(message)
    {
    }

    public BlSimulationRunningException(string? message, Exception innerException)
        : base(message, innerException)
    {
    }
}
