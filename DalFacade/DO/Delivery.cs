...
/// </summary>
/// <param name="Id">Unique ID of the delivery entity (running ID).</param>
/// <param name="OrderId">Unique ID of the order being delivered (running ID).</param>
...
/// <param name="DeliveryEndType">End type of the delivery (enum, nullable).</param>
