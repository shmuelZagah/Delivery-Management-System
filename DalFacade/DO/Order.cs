...
/// </summary>
/// <param name="Id">Personal unique ID of the order (running ID).</param>
...
/// <param name="Details">Additional details about the order (optional).</param>
