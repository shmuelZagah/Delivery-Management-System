...
internal class Program
{
    ...
    static Courier BuildCourierFromInput()
    {
        ...
        {
            Console.WriteLine("❌ Invalid input. Please enter a valid number for personal max distance.");
        }
    ...
    static Order BuildOrderFromInput()
    {
        ...
        {
            Console.WriteLine("❌ Invalid input. Using default latitude 32.0.");
        }
        ...
        if (double.TryParse(lonInput, out double lon))
            ...
            Console.WriteLine("❌ Invalid input. Using default latitude 35.0");
